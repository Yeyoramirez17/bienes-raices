...
<section class="image-contacto">
    <h2>Encuentra la casa de tus sueños</h2>
    <p>
        Llena el formulario de contacto y un asesor se pondrá en contacto a la brevedad
    </p>
...
<div class="contenedor seccion seccion-inferior">
    ...
    <section class="testimoniales"> <!-- Testimoniales -->
        ...
        <div class="testimonial">
            <blockquote>
                El personal se comporto de una excelente forma, muy buena atención y la casa que me ofreceron cumple con todas mis expectativas.
            </blockquote>
            <p>- YeYo Ramirez</p>
        </div>
    </section> <!-- End Testimoniales -->
